...
List<CatType> catType = [
  ...
  CatType(31, 'Selective Cuddler',
      'An affectionate cat who loves cuddles but on their own terms—not clingy, but devoted when they choose to show it.',
      'Love you, on my schedule.',
      31, 'Selective_Cuddler', 1.0, [
    StatValue('Energy Level', false, 2),
    StatValue('Playfulness', false, 2),
    StatValue('Affection Level', false, 4),
    StatValue('Independence', false, 5),
    ...
    'Affectionate when they choose; rewarding and genuine bond.',
    'Not needy; fine with alone time and your schedule.',
    'Quiet and low-key; won\'t demand constant attention.',
  ], [
    'May seem aloof until they decide to snuggle.',
    'Cuddles may be brief or on their terms only.',
  ]),

  CatType(32, 'Shy Sweetheart',
      'A gentle, timid cat who needs patience to blossom—once comfortable, sweet and loving.',
      'Trust takes time; love runs deep.',
      32, 'Shy_Sweetheart', 1.0, [
    StatValue('Energy Level', false, 1),
    StatValue('Playfulness', false, 1),
    StatValue('Affection Level', false, 3),
    StatValue('Independence', false, 4),
    StatValue('Sociability', false, 1),
    StatValue('Vocality', false, 1),
    StatValue('Confidence', false, 2),
    StatValue('Sensitivity', false, 4),
    StatValue('Adaptability', false, 2),
    StatValue('Intelligence', false, 3),
  ], [
    'Once bonded, very loyal and sweet; rewarding to earn their trust.',
    'Quiet and gentle; ideal for calm, predictable homes.',
    'Low maintenance; won\'t be underfoot or demanding.',
  ], [
    'Needs patience; may take weeks or months to feel safe.',
    'Easily stressed by change, loud noises, or frequent guests.',
  ]),

  CatType(33, 'Vocal Observer',
      'A talkative cat who has plenty to say but prefers to observe from a distance—engaged but not in your lap.',
      'I have opinions; I\'ll share them from here.',
      33, 'Vocal_Observer', 1.0, [
    StatValue('Energy Level', false, 3),
    StatValue('Playfulness', false, 2),
    StatValue('Affection Level', false, 2),
    StatValue('Independence', false, 4),
    ...
    'You always know where they are and what they think; clear communication.',
    'Independent; won\'t demand cuddles but stays engaged.',
    'Confident and self-assured; not fearful, just selective.',
  ], [
    'Can be loud; may not suit apartments or light sleepers.',
    'May not be the cuddly type despite being vocal.',
  ]),

  CatType(34, 'Burst Player',
      'A cat who loves to play in short, intense bursts then rests—playful but not high-energy all day.',
      'Short sprints, long naps.',
      34, 'Burst_Player', 1.0, [
    StatValue('Energy Level', false, 2),
    StatValue('Playfulness', false, 4),
    StatValue('Affection Level', false, 3),
    ...
    'Fun play sessions without all-day zoomies; manageable energy.',
    'Adaptable; enjoys toys and interaction in moderation.',
    'Balanced; great for people who want play but not a nonstop cat.',
  ], [
    'May need short daily play sessions to stay content.',
    'Can seem lazy between bursts if you expect constant activity.',
  ]),

  CatType(35, 'Nervous Sprite',
      'A high-energy cat who is easily stimulated and sensitive—active and curious but needs a calm, understanding home.',
      'All the energy; all the feelings.',
      35, 'Nervous_Sprite', 1.0, [
    StatValue('Energy Level', false, 4),
    StatValue('Playfulness', false, 3),
    StatValue('Affection Level', false, 3),
    StatValue('Independence', false, 2),
    ...
    'Engaging and active; can be very loving when feeling safe.',
    'Expressive; you\'ll know how they feel and can respond.',
    'Thrives in a stable home with predictable routines and patience.',
  ], [
    'Easily stressed by change, noise, or chaotic environments.',
    'May startle or hide; needs gentle handling and time to adjust.',
  ]),

  CatType(36, 'Creature of Habit',
      'A cat who thrives on routine and predictability—reliable and steady when their schedule is respected.',
      'Same time, same place, every day.',
      36, 'Creature_of_Habit', 1.0, [
    StatValue('Energy Level', false, 2),
    StatValue('Playfulness', false, 2),
    StatValue('Affection Level', false, 3),
    StatValue('Independence', false, 3),
    ...
    'Predictable and reliable; easy to plan your day around.',
    'Steady and low-drama when routine is kept.',
    'Quiet and confident; good for structured households.',
  ], [
    'Struggles with change; moves or schedule shifts can be very stressful.',
    'May become anxious or upset if routines are disrupted often.',
  ]),
];
